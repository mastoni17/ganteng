...
# ==========================================
#  MASTONI GANTENG - UPDATE SCRIPT (THEMED)
# ==========================================
...
# ==================================================
# FUNGSI GRADASI (SESUAI TEMA MASTONI)
# ==================================================
print_gradient() {
    local text="$1"
...
run_update() {
    ...
    wget https://github.com/mastoni17/ganteng/raw/refs/heads/main/menu/menu.zip
...
echo -e ""
print_gradient "╭══════════════════════════════════════════╮"
print_gradient "│      MASTONI GANTENG SYSTEM UPDATER        │"
print_gradient "╰══════════════════════════════════════════╯"
echo -e ""
echo -e "  ${ORANGE}Please wait while we update your resources...${NC}"
echo -e ""

mastoni_anim 'run_update'
