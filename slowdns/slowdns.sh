...
# =========================================
# [INFO] Integrasi Otomatis dengan Bot Mastoni Ganteng
# =========================================
...
if [[ -n "$AUTO_NS" ]]; then
    ...
    NS_DOMAIN=${manual_ns:-"ns.mastoni.site"}
fi
...
REPO="https://raw.githubusercontent.com/mastoni17/ganteng/refs/heads/main/slowdns"
...
[Unit]
Description=Server SlowDNS By Mastoni Ganteng
...
[Unit]
Description=Client SlowDNS By Mastoni Ganteng
After=network.target nss-lookup.target
...
if [[ -n "$AUTO_CHATID" ]]; then
    ...
    TEXT+="<code>─────────────────────────────</code>%0A"
    TEXT+="🚀 <b>Mastoni Ganteng SlowDNS Service</b>"
